...
"找到最相近的几个处方"
knn = joblib.load('F:/medical_result/distance_index/filename.pkl')
...
f1=open('F:/medical_result/label_B.txt','r')
label_B=[]
...
f2=open('F:/medical_result/label_C.txt','r')
label_C=[]
for li in f2.readlines():
...
f3=open('F:/medical_result/label_D.txt','r')
label_D=[]
...
f4=open('F:/medical_result/label_E.txt','r')
label_E=[]
...
"疗效:"
clf8 = joblib.load('F:/medical_result/cure_after/filename2.pkl')
...
feature1_index=[]
X_index=[]
f5=open("F:/medical_result/feature1.txt","r")
...
#找出概率最大的几个事件
f6=open("F:/medical_result/result_x_0.7.txt","r")
index_dict={}
...
print "西药（A）:",
for li in list(set(medical0)):
    print li.decode('utf-8'),
print

print "中成药（B）:",
for li in list(set(medical1)):
    print li.decode('utf-8'),
print

print "中草药（C）:",
for li in list(set(medical2)):
    print li.decode('utf-8'),
print

print "检验（D）:",
for li in list(set(medical3)):
    print li.decode('utf-8'),
print

print "检查（E）:",
for li in list(set(medical4)):
    print li.decode('utf-8'),
print
